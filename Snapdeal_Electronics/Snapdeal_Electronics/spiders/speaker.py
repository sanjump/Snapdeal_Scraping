...
class SnapdealSpider(scrapy.Spider):
    ...
    name = 'snapspeaker'
    pageno =20
    start_urls=['https://www.snapdeal.com/acors/json/product/get/search/631/0/20?q=&sort=plrty']
    ...
    def parse(self, response):
        ...
        page = 'https://www.snapdeal.com/acors/json/product/get/search/631/' + str(SnapdealSpider.pageno) + '/20?q=&sort=plrty'
        if SnapdealSpider.pageno <= 200:
