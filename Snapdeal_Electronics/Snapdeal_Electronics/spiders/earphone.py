...
class SnapdealSpider(scrapy.Spider):
    ...
    start_urls=['https://www.snapdeal.com/acors/json/product/get/search/288/0/20?q=&sort=plrty']
    ...
    def parse(self, response):
        ...
        page = 'https://www.snapdeal.com/acors/json/product/get/search/288/' + str(SnapdealSpider.pageno) +'/20?q=&sort=plrty'
        if SnapdealSpider.pageno <= 400:
